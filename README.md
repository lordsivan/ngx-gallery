...
[![npm version](https://badge.fury.io/js/%40sivathanu%2Fngx-gallery.svg)](https://badge.fury.io/js/%40sivathanu%2Fngx-gallery)
[![demo](https://img.shields.io/badge/demo-StackBlitz-blueviolet.svg)](https://stackblitz.com/edit/sivathanu-ngx-gallery)
[![Build Status](https://travis-ci.com/sivathanu/ngx-gallery.svg?branch=master)](https://travis-ci.com/sivathanu/ngx-gallery)
[![npm](https://img.shields.io/npm/dw/@sivathanu/ngx-gallery.svg)](https://www.npmjs.com/package/@sivathanu/ngx-gallery)
[![](https://data.jsdelivr.com/v1/package/npm/@sivathanu/ngx-gallery/badge?style=rounded)](https://www.jsdelivr.com/package/npm/@sivathanu/ngx-gallery)
[![Coverage Status](https://coveralls.io/repos/github/sivathanu/ngx-gallery/badge.svg?branch=master)](https://coveralls.io/github/sivathanu/ngx-gallery?branch=master)
[![dependencies Status](https://david-dm.org/sivathanu/ngx-gallery/status.svg)](https://david-dm.org/sivathanu/ngx-gallery)
[![devDependencies Status](https://david-dm.org/sivathanu/ngx-gallery/dev-status.svg)](https://david-dm.org/sivathanu/ngx-gallery?type=dev)
[![codecov](https://codecov.io/gh/sivathanu/ngx-gallery/branch/master/graph/badge.svg)](https://codecov.io/gh/sivathanu/ngx-gallery)
[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://paypal.me/Andreysivathanu)

## Demo
Demo is here [demo][demo]

Working code for this demo at stackblitz [example](https://stackblitz.com/edit/sivathanu-ngx-gallery)
...
```bash
npm install @sivathanu/ngx-gallery --save
```
### Versions
...
import { NgxGalleryModule } from '@sivathanu/ngx-gallery';
...
import {NgxGalleryOptions} from '@sivathanu/ngx-gallery';
import {NgxGalleryImage} from '@sivathanu/ngx-gallery';
import {NgxGalleryAnimation} from '@sivathanu/ngx-gallery';
...
Please read through our [contributing guidelines](https://github.com/sivathanu/ngx-gallery/blob/master/CONTRIBUTING.md). Included are directions for opening issues, coding standards, and notes on development.

Editor preferences are available in the [editor config](https://github.com/sivathanu/ngx-gallery/blob/master/.editorconfig) for easy use in common text editors. Read more and download plugins at <http://editorconfig.org>.
...
See [the Releases section of our project](https://github.com/sivathanu/ngx-gallery/releases) for changelogs for each release version.

## Creators

**Andrey sivathanu**

* <https://github.com/sivathanu>
...
If you like my work, and I save your time you can buy me a :beer: or :pizza: [![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://paypal.me/Andreysivathanu)

[npm]: https://www.npmjs.com/
[demo]: https://sivathanu-ngx-gallery.stackblitz.io/
[example]: https://stackblitz.com/edit/sivathanu-ngx-gallery
